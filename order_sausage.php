...
session_start();
include "koneksi.php";
$sql = mysqli_query($koneksi, "SELECT * FROM tb_admin WHERE id = '4'");
...
// REDIRECT TO WA
  ...
  $send = "https://wa.me/$nomor?text=HALO ADMIN%0A%0A *INFO ORDER TOP UP* %0AGAME SAUSAGE SMAN%0A %0A ID GAME+:++ $id  %0A ITEM +:++ $dm %0A HARGA +:++ $dmharga %0A METODE PEMBAYARAN +:++ $metode";
...
<div class="container">
  <div class="mt-3 p-2"><img src="img/s.jpg" style="width:100%" alt=""></div>


  <h4 class="shadow-sm p-2 mt-3">SAUSAGE SMAN</h4>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body text-dark">
        Masukkan id game sesuai dengan id game anda
      </div>
